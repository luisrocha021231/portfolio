...
export default function Hero() {
  ...
  return (
    <section id="inicio" className="h-screen flex flex-col justify-center items-center bg-[#121212] text-white">
      <div className="bg-[#1e1e1f] rounded-2xl shadow-lg p-8 w-80 text-center">
        
        {/* Avatar */}
        <div className="relative w-32 h-32 mx-auto mb-4">
          <img src="/Avatar.png" alt="Perfil" className="rounded-2xl shadow-lg"/>
          {/* Contenedor del estado online */}
          <span className="absolute bottom-2 right-2 flex h-4 w-4">
            {/* Anillo de emisión más grande */}
